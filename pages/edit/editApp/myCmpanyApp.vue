...
<template>
    <div class="wrapper">
        ...
        <div class="myCmpanyApp-wrapper">
            ...
            <my-cmpany-app-item class="myCmpanyApp-item-box" v-for="item,index in cmpanyAppList" :key="item"
                                :propData="item"></my-cmpany-app-item>
            <my-cmpany-app-item class="myCmpanyApp-item-box" :propData="defaultData" @starClick="cmpanyAppItemEvent"></my-cmpany-app-item>
