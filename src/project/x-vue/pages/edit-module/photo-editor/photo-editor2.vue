    ...
    export default {
        ...
        methods: {
            photoInit(){
                ...
                let b = (this.imgData.crop_w / 750);
                this.imgData.crop_w = this.imgData.crop_w * b;
                this.imgData.crop_h = this.imgData.crop_h * b;
                this.cropperImgSrc = this.imgData.img_src;
                this.setPhotoParams();
            },
            getCropperImgSrc(img){
            ...
            setPhotoParams(){
                ...
                let crop = this.getCropParams(this.imgData.crop_w, this.imgData.crop_h, this.canvasClient.width, this.canvasClient.height);
                ...
                let cropStyleX = (this.canvasClient.width - crop.width) / 2;
                let cropStyleY = (this.canvasClient.height - crop.height) / 2;
                ...
                this.$refs.cropperWrapImg.style.height = this.$refs.cropperViewImg.style.height = this.cropperImg.height + 'px';
                this.$refs.cropperWrapImg.style.width = this.$refs.cropperViewImg.style.width = this.cropperImg.width + 'px';
                ...
                this.$refs.cropperWrap.style.webkitTransform = 'translate(' + transformX + 'px,' + transformY + 'px)';
                this.$refs.cropperViewImg.style.webkitTransform = 'translate(' + (this.cropperImgTransform.x) + 'px,' + ( this.cropperImgTransform.y) + 'px)';
