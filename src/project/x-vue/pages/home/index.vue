...
<template>
    <div class="wrapper">
        <p class="title">Every day is a new beginning222</p>
    ...
    export default {
        ...
        mounted () {
            ...
            this.linkList = [
                ...
                'editMyTpl_myTemplet',
                'editMyTpl_myCollection',
                'editMyTpl_mySnapshot',
                'editMyTpl_myHistory',
                'editApp_myCmpanyApp',
                ...
                'editModule_banner',
                'editModule_banner_edit',
                'editModule_banner_style',
                'editModule_banner_addormodify',

                'editModule_dingtalkISV',
                'editModule_dingtalkISV_edit',
                'editModule_dingtalkISV_style',
                'editModule_dingtalkISV_addormodify',

                'editModule_doMyself',
                'editModule_doMyself_edit',
                'editModule_doMyself_style',
                'editModule_doMyself_addormodify',
